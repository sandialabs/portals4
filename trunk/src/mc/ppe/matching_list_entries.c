...
#if 0
int _PtlMEAppend(ptl_handle_ni_t  ni_handle,
                         ptl_pt_index_t   pt_index,
                         ptl_me_t        *me,
                         ptl_list_t       ptl_list,
                         void            *user_ptr,
...
//    ptl_internal_handle_converter_t       meh    = { .s.selector = HANDLE_ME_CODE };
    const ptl_internal_handle_converter_t   me_hc  = (ptl_internal_handle_converter_t) me_handle;
...
# endif
        ...
        switch (hdr->type & HDR_TYPE_BASICMASK) {
            ...
            case HDR_TYPE_SWAP:
                ...
                if (me.options & PTL_ME_ACK_DISABLE) {
